<!-- START THE FEATURETTES -->
      ...
      <div class="row featurette"  data-sr="enter bottom, hustle 10px">
        <div class="col-md-7">
          ...
          <p class="lead">100% of students responded that they would do the exchange again. Still having doubts that Science without Borders is a great opportunity for your career? See the <a href="depoimentos.php">student testimonials</a>.</p>
        </div>
        <div class="col-md-5">
